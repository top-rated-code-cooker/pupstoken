    ...
    <nav className="">
      <div className="main-nav">
        ...
        <div className="nav-links">
          <NavItem text="Discover" to="./home" />
          <NavItem text="Portfolio" to="./profile" />
          <NavItem text="Inscriptions" to="./inscriptions" />
          <NavItem text="Index" to="./index/collection" />
          <NavItem text="Mint" to="./inscribe" />
        </div>
        <div
